  ...
  return (
    <div className="w-full md:w-10/12 lg:w-8/12 h-fit md:rounded-xl group mx-auto">
      <div className="w-full h-48 rounded-t-xl relative">
        ...
        <div 
          className="w-32 h-32 bg-slate-400 rounded-full absolute -bottom-12 left-1/2 transform -translate-x-1/2 md:left-6 md:translate-x-0 flex items-center justify-center">
          <ProfilePhoto />
        </div>
      </div>
      <div className="border border-solid rounded-xl pb-6">
        <div className="bg-white w-full h-64 flex flex-col">
          <div className="mt-24 ml-6 text-center md:text-left">
            <NameCard />
          </div>
        </div>
        <div className="flex">
